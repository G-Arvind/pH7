...
public class OnboardUser extends TutorialActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addFragment(new Step.Builder().setTitle("Welcome to pH7")
                .setContent("Personalized health care app with AR/VR features")
                .setDrawable(R.drawable.logo2)
                .setBackgroundColor(Color.parseColor("#211D44")) // int background color
                .build());
